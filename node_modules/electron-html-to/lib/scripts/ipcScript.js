...
var windows = [],
    ...
    CHROME_COMMAND_LINE_SWITCHES = undefined,
    ALLOW_LOCAL_FILES_ACCESS = undefined,
    MAX_LOG_ENTRY_SIZE = undefined;
...
function createBrowserWindow(respondIpc, settingsData) {
  var evaluateInWindow = undefined,
      dataForWindow = {},
      browserWindowOpts = undefined,
  ...
  saveLogsInStore(global.windowsLogs[currentWindowId], 'debug', 'Converting using electron-ipc strategy in electron ' + electronVersion);

  currentWindow.webContents.setAudioMuted(true);

  listenRequestsInPage(currentWindow, {
    allowLocalFilesAccess: ALLOW_LOCAL_FILES_ACCESS,
    pageUrl: settingsData.url
  }, log, saveLogsInStore(global.windowsLogs[currentWindowId]));
